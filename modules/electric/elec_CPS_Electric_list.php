<header class="entry-header">
   <h1 class="entry-title"><?php echo str_replace("_", " ", substr($page, 5)); ?> Lookup</h1>
</header>
...
<?php
         ...
         $table_name    = "elec_CPS Electric";
         $url_name         = str_replace(" ", "_", $table_name);
         $select_columns   = "[Project name],  [Project location (city)], [Contact owner], [Contact phone # owner]";
