      ...
      if ($key) {
         ...
         if ($rows > 0) {
           ...
           $template->setValues(array(
              ...
              "contact_first_name"     => htmlspecialchars($contact['First name']),
              "contact_last_name"      => htmlspecialchars($contact['Last name']),
              "contact_company"        => htmlspecialchars($contact['Company']),
              "contact_phone"          => htmlspecialchars($contact['Phone number']),
              "contact_cell_phone"     => htmlspecialchars($contact['Cell number']),
              "contact_email"          => htmlspecialchars($contact['Email']),
              "contact_title"          => htmlspecialchars($contact['Title']),
              "contact_division"       => htmlspecialchars($contact['Division']),
              "contact_epa_number"     => htmlspecialchars($contact['EPA number']),
              "contact_er_number"	   => htmlspecialchars($contact['ER number']),
              "contact_noi_signer"	   => ($contact['NOI Signer'] == "1") ? 'checked' : '',
