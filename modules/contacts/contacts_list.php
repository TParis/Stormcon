<header class="entry-header">
   <h1 class="entry-title">Contact Lookup</h1>
</header>
...
<?php
         ...
         $table_name    = "contacts";
         $select_columns   = "[First name], [Last name], [Company], [Title], [Phone number]";
         $order_by         = "[Last name], [First name]";
         ...
         echo "\t\t" . $label_div . "Contact name" . $close_div . "\n";
         echo "\t\t" . $label_div . "Company" . $close_div . "\n";
         echo "\t\t" . $label_div . "Position" . $close_div . "\n";
         echo "\t\t" . $label_div . "Phone number" . $close_div . "\n";
         echo "\t" . $close_div . "\n";
         ...
         foreach ($results as $row) {
            ...
            echo "\t\t" . $data_div;
               echo "<a href=\"?page=" . $table_name . "_item&action=view&id=" . $row['id'] . "\"><img src=\"/images/view.png\"></a>&nbsp;";
