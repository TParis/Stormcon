<header class="entry-header">
   <h1 class="entry-title">Responsibility</h1>
</header>
...
<?php
         ...
         switch($action) {
            ...
            case "delete":
               ...
               LogActivity($sys->auth()->user_name, "DELETE RESPONSIBILITY_ID: " . $id);
            ...
            case "edit":
               if (ISSET($_POST['submit-action'])) {
                  if ($_POST['submit-action'] == "add") {
                     ...
                     LogActivity($sys->auth()->user_name, "INSERT RESPONSIBILITY_ID: " . $new_id);
                     ...
                     LogActivity($sys->auth()->user_name, "UPDATE RESPONSIBILITY_ID: " . $id);
