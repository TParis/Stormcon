<header class="entry-header">
   <h1 class="entry-title">Responsibility Lookup</h1>
</header>
...
<?php
         ...
         $select_columns   = "[Responsibility narative]";
         $order_by         = "[Responsibility narative]";
         ...
         echo "\t\t" . $label_div . "Responsibility narative" . $close_div . "\n";
         echo "\t" . $close_div . "\n";
