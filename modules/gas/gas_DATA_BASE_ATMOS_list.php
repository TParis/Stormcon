<header class="entry-header">
   <h1 class="entry-title"><?php echo str_replace("_", " ", substr($page, 4)); ?> Lookup</h1>
</header>
...
<?php
         ...
         $table_name    = "gas_DATA BASE ATMOS";
         $url_name         = str_replace(" ", "_", $table_name);
         $select_columns   = "[Project name],  [project location (city)], [Contact], [Contact phone # owner]";
