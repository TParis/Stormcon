...
<?php
         ...
         $table_name       = "ld_Lennar LD";
         $url_name         = str_replace(" ", "_", $table_name);
         $select_columns   = "[Stormcon Project number], [Project city], [Contact Owner], [Contact phone Owner]";
         $order_by         = "[Stormcon Project number]";
         ...
         echo "\t\t" . $label_div . "Contact" . $close_div . "\n";
