<header class="entry-header">
   <h1 class="entry-title">Inspection Schedule Lookup</h1>
</header>
...
<?php
         ...
         echo "\t\t" . $label_div . "Short Name" . $close_div . "\n";
         echo "\t\t" . $label_div . "Full Description" . $close_div . "\n";
         echo "\t" . $close_div . "\n";
         ...
         foreach ($results as $row) {
            ...
            echo "\t\t" . $data_div;
               echo "<a href=\"?page=" . $url_name . "_item&action=view&id=" . $row['is_id'] . "\"><img src=\"/images/view.png\"></a>&nbsp;";
               echo "<a href=\"?page=" . $url_name . "_item&action=edit&id=" . $row['is_id'] . "\"><img src=\"/images/edit.png\"></a>&nbsp;";
               echo "<a href=\"?page=" . $url_name . "_item&action=delete&id=" . $row['is_id'] . "\" class=\"item-delete\"><img src=\"/images/delete.png\"></a>";
            echo $close_div . "\n";
            echo "\t\t" . $data_div . htmlspecialchars($row[1]) . $close_div . "\n";
            echo "\t\t<div class=\"column_data\" style=\"width: 50%\">" . limit_string(htmlspecialchars($row[2]), 90) . $close_div . "\n";
