<header class="entry-header">
   <h1 class="entry-title">Endangered Species Lookup</h1>
</header>
...
<?php
         ...
         $select_columns   = "es_county, es_1_common_name, es_2_common_name, es_3_common_name";
         $order_by         = "es_county";

         $page_limit       = (ISSET($_GET['limit']) && is_numeric($_GET['limit'])) ? $_GET['limit'] : 20;

         //Start to build SQL Statement for general results
         $sql              = "SELECT es_id, " . $select_columns . " FROM [dbo].[" . $table_name . "]";
         ...
         echo "<div class=\"pageination\"><span class=\"add-new\"><a href=\"?page=" . $table_name . "_item&action=add\">Add New</a></span>";
         ...
         echo "\t\t" . $label_div . "County" . $close_div . "\n";
         echo "\t\t" . $label_div . "Species 1" . $close_div . "\n";
         echo "\t\t" . $label_div . "Species 2" . $close_div . "\n";
         echo "\t\t" . $label_div . "Species 3" . $close_div . "\n";
         echo "\t" . $close_div . "\n";
         ...
         foreach ($results as $row) {
            ...
            echo "\t\t" . $data_div;
               echo "<a href=\"?page=" . $url_name . "_item&action=view&id=" . $row['es_id'] . "\"><img src=\"/images/view.png\"></a>&nbsp;";
               echo "<a href=\"?page=" . $url_name . "_item&action=edit&id=" . $row['es_id'] . "\"><img src=\"/images/edit.png\"></a>&nbsp;";
               echo "<a href=\"?page=" . $url_name . "_item&action=delete&id=" . $row['es_id'] . "\" class=\"item-delete\"><img src=\"/images/delete.png\"></a>";
            echo $close_div . "\n";
