<?php
	...
	require_once("home_building.class.php");
	...
	switch ($action) {
		...
		case "delete":
			...
			LogActivity($sys->auth()->user_name, "DELETE HB_ID: " . $id);
		...
		case "add":
			...
			if (isset($_POST['submit'])) {
				...
				LogActivity($sys->auth()->user_name, "INSERT HB_ID: " . $curr_obj->id);
