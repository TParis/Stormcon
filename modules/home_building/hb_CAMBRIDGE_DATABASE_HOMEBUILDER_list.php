...
<?php
         ...
         $table_name    = "hb_CAMBRIDGE DATABASE HOMEBUILDER";
         $url_name         = str_replace(" ", "_", $table_name);
         $select_columns   = "[Subdivision and Phase],  [Project location], [contact], [Contact Phone]";
         $order_by         = "[Subdivision and Phase]";
         ...
         echo "\t\t" . $label_div . "Subdivision and Phase" . $close_div . "\n";
