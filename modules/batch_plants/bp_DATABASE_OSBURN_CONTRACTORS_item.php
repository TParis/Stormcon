...
<?php
         ...
         $table_name = 'bp_DATABASE OSBURN CONTRACTORS';
            ...
            default:
              ...
              for ($i = 0; $i < count($table_fields); $i++) {
                 ...
                 switch (strtolower($row_type)) {
                    case "team name 1-edit":
                    case "team name 2-edit":
                    case "team name 3-edit":
                    case "team name 4-edit":
                    case "team name 1-add":
                    case "team name 2-add":
                    case "team name 3-add":
                    case "team name 4-add":
                       echo $label_div . $table_fields[$i]["COLUMN_NAME"] . $close_div . "\n";
                       echo $data_div;
                       echo "<select name=\"" . $table_fields[$i]["COLUMN_NAME"] . "\" class=\"team-class\">\n";
                       echo "\t\t\t<option value=\"\"></option>\n";
                          //GET CLIENT NAMES
                          $stmt = $dbh->prepare("SELECT * FROM [dbo].[Contact];");
                          ...
                          foreach ($clients as $client) {
                             echo "\t\t\t<option value=\"" . $client['ID'] . "-" . $client['Last name'] . ', ' . $client['First name'] . "\">" . $client['Last name'] . ', ' . $client['First name'] . "</option>\n";
                          }
                       echo "\t\t</select>\n";
                       echo "\t" . $close_div . "\n";
                       break;
