...
<?php
         ...
         switch($action) {
            ...
            case "delete":
               ...
               LogActivity($sys->auth()->user_name, "DELETE SOIL_ID: " . $id);
            ...
            case "edit":
               if (ISSET($_POST['submit-action'])) {
                  if ($_POST['submit-action'] == "add") {
                     ...
                     LogActivity($sys->auth()->user_name, "INSERT SOILS_ID: " . $new_id);
                     ...
                     LogActivity($sys->auth()->user_name, "UPDATE SOILS_ID: " . $id);
