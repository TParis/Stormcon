<header class="entry-header">
   <h1 class="entry-title">Soils Lookup</h1>
</header>
...
<?php
         ...
         $table_name    = "soils";
         $select_columns   = "[Soil name], [Soil hydrologic Group], [K factor], [Sand %]";
         $order_by         = "[Soil name]";
         ...
         echo "\t\t" . $label_div . "Hydrologic Group" . $close_div . "\n";
         echo "\t\t" . $label_div . "K factor" . $close_div . "\n";
         echo "\t\t" . $label_div . "Sand %" . $close_div . "\n";
         echo "\t" . $close_div . "\n";
