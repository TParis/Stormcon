            ...
            case "edit":
               if (ISSET($_POST['submit-action'])) {
                  if ($_POST['submit-action'] == "add") {
                     ...
                     LogActivity($sys->auth()->user_name, "INSERT BMPS_ID: " . $new_id);
                     ...
                     LogActivity($sys->auth()->user_name, "UPDATE BMPS_ID: " . $id);
            ...
            default:
              ...
              for ($i = 0; $i < count($table_fields); $i++) {
                 ...
                 switch (strtolower($row_type)) {
                    ...
                    case "id-edit":
                    case "id-view":
                       echo "<input class=\"edit\" type=\"hidden\" value=\"" . $results[$table_fields[$i]["COLUMN_NAME"]] . "\" name=\"" . $table_fields[$i]["COLUMN_NAME"] . "\"></input>\n";
                       break;
                    case "textfield-edit":
                       echo $row_div . "\n";
