<header class="entry-header">
   <h1 class="entry-title"><?php echo strtoupper($page); ?> Lookup</h1>
</header>
...
<?php
         ...
         $select_columns   = "[BMP], [Description], [considerations], [maintenance]";
         $order_by         = "[BMP]";
         ...
         echo "\t\t" . $label_div . "BMP" . $close_div . "\n";
         echo "\t\t" . $label_div . "Consideration" . $close_div . "\n";
         echo "\t\t" . $label_div . "Description" . $close_div . "\n";
         echo "\t\t" . $label_div . "Maintenance" . $close_div . "\n";
         echo "\t" . $close_div . "\n";
         ...
         foreach ($results as $row) {
            ...
            echo "\t\t" . $data_div . limit_string($row[2], 30) . $close_div . "\n";
            echo "\t\t" . $data_div . limit_string($row[3], 30) . $close_div . "\n";
            echo "\t\t" . $data_div . limit_string($row[4], 30) . $close_div . "\n";
